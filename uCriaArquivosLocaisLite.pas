...
begin
  ...
  do begin
    ...
    FieldDefs.Add('Quant',ftBCD,3);                 // 8
    FieldDefs.Add('VlrUnit',ftCurrency);            // 9
    FieldDefs.Add('TpDesc',ftSmallint);             // 10
    FieldDefs.Add('VlrDesc',ftCurrency);            // 11
    FieldDefs.Add('PercDesc',ftBCD,5);              // 12    5 decimais
    ...
    FieldDefs.Add('BaseICM',ftBCD,4);               // 18    4 decimais
    ...
    FieldDefs.Add('ST_QtComp',ftBCD,3);             // 34    3 decimais
    FieldDefs.Add('ST_MVA',ftBCD,4);                // 35    4 decimais
    ...
    FieldDefs.Add('Imp_Aliq',ftBCD,3);              // 52   3 decimais
    FieldDefs.Add('Imp_VlrImposto',ftCurrency);     // 53
    FieldDefs.Add('Imp_VlrIOF',ftCurrency);         // 54
    FieldDefs.Add('Imp_AliqPIS',ftBCD,3);           // 55   3 decimais
    FieldDefs.Add('Imp_VlrPIS',ftCurrency);         // 56
    FieldDefs.Add('Imp_AliqCOFINS',ftBCD,3);        // 57   3 decimais
    FieldDefs.Add('Imp_VlrCOFINS',ftCurrency);      // 58
    FieldDefs.Add('Imp_Indice',ftBCD,6);            // 59   6 decimais
    FieldDefs.Add('DescUnit',ftInteger);            // 60
    FieldDefs.Add('LiqUnit',ftInteger);             // 61
    FieldDefs.Add('PesoLiq',ftBCD,3);               // 62   3 decimais
    FieldDefs.Add('QtdEmb',ftSmallint);             // 63
    FieldDefs.Add('PesoEmb',ftBCD,3);               // 64   3 decimais
    ...
    FieldDefs.Add('QtdTrib',ftBCD,3);               // 76   3 decimais
